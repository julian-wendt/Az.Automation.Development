function Get-AutomationVariable {
    ...
    .DESCRIPTION
    Intended for Azure Automation Runbook development on local machines, this function emulates the built-in Automation function "Get-AutomationVariable". Therefore the "Microsoft.PowerShell.SecretManagement" module
    is used to safely return sensitive information like secrets or keys. To store them, simply use the Set-Secret command". Less sensitive information can also be stored next to the environment details in the settings file.
